...
export default function BlobImgContainer({ type, src, text, dest }) {
  ...
  switch (type) {
    ...
    case "3":
      svgPath =
        "M31.9,-43C38.8,-32.2,40.1,-19.7,40.8,-8.3C41.6,3.2,41.8,13.7,38.1,23.7C34.4,33.8,26.8,43.3,15.5,51.2C4.2,59,-10.9,65.2,-18.9,59.2C-26.8,53.1,-27.7,34.8,-36.1,20.6C-44.6,6.5,-60.7,-3.5,-65.8,-18C-70.8,-32.5,-64.9,-51.4,-52.1,-61.2C-39.3,-71,-19.7,-71.7,-3.6,-67.4C12.5,-63.2,25,-53.9,31.9,-43Z"
      translate = "-20 -20"
      id = "3"
      break
    case "4":
